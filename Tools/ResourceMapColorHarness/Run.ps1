...
$generated += Read-Member $paper 'private void RefreshStaticMapMarkers('
$generated += Read-Member $paper 'private void RefreshLiveTrainMarkers('
$generated += Read-Member $paper 'private void UploadComposedPixels('
