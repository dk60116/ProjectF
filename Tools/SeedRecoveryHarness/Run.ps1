...
$generated += (Read-Member ($base + 'InstallationObject/LoggingMachine.cs') 'private void RecoverHarvestedSeeds(') + "`n"
$generated += (Read-Member ($base + 'InstallationObject/LoggingMachine.cs') 'private static bool CanDropTreeLogs(') + "`n}`npublic partial class Block {`n"
