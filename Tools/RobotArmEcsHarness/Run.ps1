...
$markers = 'FactorioProject/Assets/Scripts/Map/AreaMarkerRenderer.cs'
...
Require-Text $markers 'ownersByCell.TryGetValue(' 'area-marker visibility queries indexed owner cells'
Require-Text $markers 'foreach (InputOutputModuleAreaMarkerController owner in visibleOwners)' 'previously visible area markers receive an exit transition'
Require-Text $world 'markerArmsByCell.TryGetValue(' 'robot-arm marker visibility queries indexed cells'
Require-Text $markers '"VisibilityCandidateOwners"' 'area-marker candidate count remains profiler-visible'
